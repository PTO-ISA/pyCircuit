...
// One-hot mux.  This is the vendored OpenTitan primitive used by the
// packed-port runtime adapter.
...
module prim_onehot_mux #(
  ...
  // Clock and reset are present only for the assertion contract.
  input clk_i,
  input rst_ni,
