...
cat > "${docs_gate_dir}/agentic_circuit_summary.json" <<EOF
{
  ...
  "contract_epoch": "0.5",
  "pyc_interface": "pyc6",
  "cases": ["arbiter", "atomic-transform", "bit-widths", "masked-match", "popcount", "typed-integer-runtime", "bounded-range-runtime", "array-combinator-runtime", "enum-helper-runtime", "enum-stress-runtime", "record-projection-runtime", "multi-output-atomic", "rule-retirement", "bitfield", "masked-decode", "nested-payload", "enum-payload", "aggregate-payload", "recursive-aggregate-payload", "typed-system-transactions", "typed-record-pyc", "multi-output-state-gfsim", "multi-output-pyc-parity", "aggregate-equality-invariant-gfsim", "aggregate-equality-invariant-pyc-parity", "table-round-robin-pyc-parity", "table-writer-arbitration-pyc-parity", "table-field-replace-order-pyc-parity", "table-direct-native-gfsim"]
}
EOF
