...
**Status:** Proposed
**Baseline:** pyCircuit 6.1.0（决策登记截至 0278；release identity 位于 IR 外部）
...
**Status 为 Proposed implementation RFC。** Decisions 0271–0278 已接受本文中 F0
收敛的 contract；本文其余 recovery、transaction、memory-order 与 refinement 内容仍需按阶段决策。

1. Decisions 0273–0278 在 `docs/gates/decision_status_v6.md` 中保持 `gap-in-scope`；
