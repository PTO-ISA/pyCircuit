...
## Primitive operations (combinational)
...
## Primitive operations (ready/valid)

### `pyc_fifo` (single-clock, strict ready/valid)
...
### `pyc_async_fifo` (dual-clock, strict ready/valid)
...
### `pyc_cdc_sync` (dst-clocked synchronizer)
...
## Generated C++ module-eval caching
