...
$tcl = switch ($Core) {
  "InOrder" { Join-Path $repo "platforms\\zybo_z7_20\\vivado\\build_zybo_linx_platform_inorder.tcl" }
  "OOO"     { Join-Path $repo "platforms\\zybo_z7_20\\vivado\\build_zybo_linx_platform_ooo.tcl" }
}
