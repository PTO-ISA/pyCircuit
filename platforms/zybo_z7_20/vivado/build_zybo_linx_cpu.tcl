...
#
# Usage:
#   vivado -mode batch -source platforms/zybo_z7_20/vivado/build_zybo_linx_cpu.tcl
#
# Optional:
...
set build_dir  [file normalize [file join $repo_root .pycircuit_out platforms zybo_z7_20 vivado linx_cpu]]
...
add_files -norecurse [file join $repo_root platforms zybo_z7_20 rtl uart_tx_8n1.sv]
add_files -norecurse [file join $repo_root platforms zybo_z7_20 rtl zybo_linx_cpu_top.sv]
add_files -norecurse [file join $repo_root .pycircuit_out examples linx_cpu_pyc linx_cpu_pyc.v]
add_files -fileset constrs_1 -norecurse [file join $repo_root platforms zybo_z7_20 constraints zybo_z7_20_linx_cpu.xdc]
