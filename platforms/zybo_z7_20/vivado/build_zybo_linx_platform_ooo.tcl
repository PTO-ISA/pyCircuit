...
#
# Usage:
#   vivado -mode batch -source platforms/zybo_z7_20/vivado/build_zybo_linx_platform_ooo.tcl
#
# Optional env vars:
...
set build_dir  [file normalize [file join $repo_root .pycircuit_out platforms zybo_z7_20 vivado linx_platform_ooo]]
...
add_files -norecurse [file join $repo_root platforms zybo_z7_20 rtl linx_platform_regs_axi.sv]
add_files -norecurse [file join $repo_root platforms zybo_z7_20 rtl linx_platform_ooo_axi.sv]
add_files -norecurse [file join $repo_root .pycircuit_out integrations janus janus_bcc_ooo_pyc janus_bcc_ooo_pyc.v]

add_files -fileset constrs_1 -norecurse [file join $repo_root platforms zybo_z7_20 constraints zybo_z7_20_leds_only.xdc]

set_property include_dirs [list [file join $repo_root library verilog]] [current_fileset]
