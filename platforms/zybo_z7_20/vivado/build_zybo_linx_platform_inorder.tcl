...
#
# Usage:
#   vivado -mode batch -source platforms/zybo_z7_20/vivado/build_zybo_linx_platform_inorder.tcl
#
# Optional env vars:
...
set build_dir  [file normalize [file join $repo_root .pycircuit_out platforms zybo_z7_20 vivado linx_platform_inorder]]
...
add_files -norecurse [file join $repo_root platforms zybo_z7_20 rtl linx_platform_inorder_axi.sv]
add_files -norecurse [file join $repo_root .pycircuit_out examples linx_cpu_pyc linx_cpu_pyc.v]
