...
set build_dir  [file normalize [file join $repo_root .pycircuit_out platforms zybo_z7_20 vivado counter]]
...
add_files -norecurse [file join $repo_root platforms zybo_z7_20 rtl zybo_counter_top.sv]
add_files -norecurse [file join $repo_root .pycircuit_out examples counter counter.v]
add_files -fileset constrs_1 -norecurse [file join $repo_root platforms zybo_z7_20 constraints zybo_z7_20_minimal.xdc]
