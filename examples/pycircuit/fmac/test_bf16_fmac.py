...
class FmacRTL:
    def __init__(self, lib_path=None):
        ...
        L.fmac_get_result.argtypes = [ctypes.c_void_p]
        L.fmac_get_result.restype = ctypes.c_uint32
        L.fmac_get_result_valid.argtypes = [ctypes.c_void_p]
        L.fmac_get_result_valid.restype = ctypes.c_uint32
        L.fmac_get_cycle.argtypes = [ctypes.c_void_p]
        L.fmac_get_cycle.restype = ctypes.c_uint64
