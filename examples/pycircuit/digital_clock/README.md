...
python3 -m pycircuit.cli build \
  examples/pycircuit/digital_clock/tb_digital_clock.py \
...
```bash
cd examples/pycircuit/digital_clock
...
python3 examples/pycircuit/digital_clock/emulate_digital_clock.py
```
