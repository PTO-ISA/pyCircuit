...
PYTHONPATH=python/pycircuit/src python -m pycircuit.cli emit \
    examples/pycircuit/applications/digital_filter/digital_filter.py \
...
$PYC_TOOLCHAIN_ROOT/bin/pycc .pycircuit_out/applications/digital_filter/generated/digital_filter.pyc \
    ...
    --out-dir=.pycircuit_out/applications/digital_filter/generated

# 2. Build shared library
c++ -std=c++20 -O2 -shared -fPIC \
    -I "$PYC_TOOLCHAIN_ROOT/include" \
    -I .pycircuit_out/applications/digital_filter/generated \
    .pycircuit_out/applications/digital_filter/generated/digital_filter.cpp \
    "$PYC_TOOLCHAIN_ROOT/lib/libpyc6_runtime.a" \
    -o .pycircuit_out/applications/digital_filter/libfilter_sim.dylib \
    examples/pycircuit/applications/digital_filter/filter_capi.cpp

# 3. Run emulator
python examples/pycircuit/applications/digital_filter/emulate_filter.py
```
