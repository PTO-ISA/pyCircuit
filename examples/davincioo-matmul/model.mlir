...
builtin.module attributes {ac.contract_epoch = "0.1"} {
  ...
  ac.module @ROB() parameters {} graph {
    ...
    ac.process @step kind "control" {
      ...
      scf.if %can_retire {
        ...
        %engine_shifted = arith.shrui %retired_desc, %c8 : i64
        %engine = arith.andi %engine_shifted, %mask3 : i64
        %opcode_shifted = arith.shrui %retired_desc, %c47 : i64
        ...
        %is_engine_s = arith.cmpi eq, %engine, %c0 : i64
        scf.if %is_engine_s {
          ac.stat.add @engine_s %retired_one : i64
        }
        %is_engine_v = arith.cmpi eq, %engine, %c1 : i64
        scf.if %is_engine_v {
          ac.stat.add @engine_v %retired_one : i64
        }
        %is_engine_c = arith.cmpi eq, %engine, %c2 : i64
        scf.if %is_engine_c {
          ac.stat.add @engine_c %retired_one : i64
        }
        %is_engine_t = arith.cmpi eq, %engine, %c3 : i64
        scf.if %is_engine_t {
  ...
  ac.module @Dispatch() parameters {} graph {
    ...
    ac.process @step kind "control" {
      ...
      scf.if %valid {
        ...
        %engine = arith.andi %shifted, %mask3 : i64
        %is_s = arith.cmpi eq, %engine, %c0 : i64
        %is_v = arith.cmpi eq, %engine, %c1 : i64
        %is_c = arith.cmpi eq, %engine, %c2 : i64
        %is_t = arith.cmpi eq, %engine, %c3 : i64
  ...
  ac.module @IssueQueueS() parameters {} graph {
    ...
    ac.process @step kind "control" {
      ...
      %q0_dv_s = arith.shrui %q0_desc, %c44 : i64
      %q0_dvalid = arith.andi %q0_dv_s, %mask7 : i64
      %q0_dep0_shift = arith.constant 20 : i64
      ...
      %q0_dep1_shift = arith.constant 28 : i64
      ...
      %q0_dep2_shift = arith.constant 36 : i64
      ...
      %q1_dv_s = arith.shrui %q1_desc, %c44 : i64
      %q1_dvalid = arith.andi %q1_dv_s, %mask7 : i64
      %q1_dep0_shift = arith.constant 20 : i64
      ...
      %q1_dep1_shift = arith.constant 28 : i64
      ...
      %q1_dep2_shift = arith.constant 36 : i64
      ...
      %q2_dv_s = arith.shrui %q2_desc, %c44 : i64
      %q2_dvalid = arith.andi %q2_dv_s, %mask7 : i64
      %q2_dep0_shift = arith.constant 20 : i64
      ...
      %q2_dep1_shift = arith.constant 28 : i64
      ...
      %q2_dep2_shift = arith.constant 36 : i64
      ...
      %q3_dv_s = arith.shrui %q3_desc, %c44 : i64
      %q3_dvalid = arith.andi %q3_dv_s, %mask7 : i64
      %q3_dep0_shift = arith.constant 20 : i64
      ...
      %q3_dep1_shift = arith.constant 28 : i64
      ...
      %q3_dep2_shift = arith.constant 36 : i64
      ...
      %q4_dv_s = arith.shrui %q4_desc, %c44 : i64
      %q4_dvalid = arith.andi %q4_dv_s, %mask7 : i64
      %q4_dep0_shift = arith.constant 20 : i64
      ...
      %q4_dep1_shift = arith.constant 28 : i64
      ...
      %q4_dep2_shift = arith.constant 36 : i64
      ...
      %q5_dv_s = arith.shrui %q5_desc, %c44 : i64
      %q5_dvalid = arith.andi %q5_dv_s, %mask7 : i64
      %q5_dep0_shift = arith.constant 20 : i64
      ...
      %q5_dep1_shift = arith.constant 28 : i64
      ...
      %q5_dep2_shift = arith.constant 36 : i64
      ...
      %q6_dv_s = arith.shrui %q6_desc, %c44 : i64
      %q6_dvalid = arith.andi %q6_dv_s, %mask7 : i64
      %q6_dep0_shift = arith.constant 20 : i64
      ...
      %q6_dep1_shift = arith.constant 28 : i64
      ...
      %q6_dep2_shift = arith.constant 36 : i64
      ...
      %q7_dv_s = arith.shrui %q7_desc, %c44 : i64
      %q7_dvalid = arith.andi %q7_dv_s, %mask7 : i64
      %q7_dep0_shift = arith.constant 20 : i64
      ...
      %q7_dep1_shift = arith.constant 28 : i64
      ...
      %q7_dep2_shift = arith.constant 36 : i64
  ...
  ac.module @EngineS() parameters {} graph {
    ...
    ac.process @step kind "control" {
      ...
      scf.if %idle {
        ...
        scf.if %valid {
          %desc = ac.trace.decode %handle : i64 to i64
          %lat_shifted = arith.shrui %desc, %c10 : i64
          %latency = arith.andi %lat_shifted, %c1023 : i64
