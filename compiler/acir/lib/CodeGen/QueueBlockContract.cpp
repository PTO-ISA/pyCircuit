...
const std::vector<QueueBlockContract> Contracts = {
    ...
    {"firing",
     ...
     1,
     1,
     "one_table_replace_and_queue_effects_share_commit_group",
     {"table", "mode", "write_fields", "handshake", "schedule"},
     true,
     "gfsim::QueueTableTransition",
     false,
     "unsupported_provisional_table",
     {"input_transaction", "output_transaction", "table_write_proposal",
      "firing"}},
    {"table_match",
     "ac.table.match",
     "state",
