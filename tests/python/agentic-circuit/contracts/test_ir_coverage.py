...
def load_coverage_checker():
    path = ROOT / "tools/agentic-circuit/check-ir-coverage.py"
...
FIXTURE_FILES = {
    "schemas/agentic-circuit/contracts/acir.yaml": ACIR_MANIFEST,
    "schemas/agentic-circuit/contracts/acsim.yaml": ACSIM_MANIFEST,
    "compiler/acir/include/acir/Dialect/ACIR/ACIROps.td": (
        'def ACIR_SystemOp : ACIR_Op<"system", [Symbol]> {\n}\n'
    ),
    "compiler/acir/include/acir/Dialect/ACIR/ACIRTypes.td": (
        'def ACIR_StructType : ACIR_LayoutNamedType<"Struct", "struct">;\n'
    ),
    "compiler/acir/include/acir/Dialect/ACSim/ACSimOps.td": (
        'def ACSim_ModelOp : ACSim_Op<"model", [Symbol]> {\n}\n'
    ),
    "compiler/acir/include/acir/Dialect/ACSim/ACSimTypes.td": (
        'def ACSim_ValueType : ACSim_SymbolType<"Value", "value">;\n'
    ),
    "compiler/acir/lib/Dialect/ACIR/ACIRTypes.cpp": (
        "void initialize() {\n"
        "  addTypes<\n"
    ...
    "compiler/acir/lib/Dialect/ACSim/ACSimTypes.cpp": (
        "void initialize() {\n"
        "  addTypes<\n"
    ...
    "tests/mlir/agentic-circuit/ACIR/system-valid.mlir": "ac.system @soc root @Top {}\n!ac.struct<@s>\n",
    "tests/mlir/agentic-circuit/ACIR/system-invalid.mlir": "ac.system\n!ac.struct<@s>\n",
    "tests/mlir/agentic-circuit/ACSim/model-valid.mlir": "acsim.model @m {}\n!acsim.value<@v>\n",
    "tests/mlir/agentic-circuit/ACSim/model-invalid.mlir": "acsim.model\n!acsim.value<@v>\n",
}
...
class IRCoverageTest(unittest.TestCase):
    ...
    def test_manifest_missing_operation_is_reported(self):
        temporary_directory, root = initialize_coverage_fixture(
            overrides={
                "schemas/agentic-circuit/contracts/acir.yaml": ACIR_MANIFEST.replace(
                    "operations:\n  - ac.system\n", "operations: []\n"
                )
            }
        )
    ...
    def test_manifest_extra_operation_needs_source_symbol(self):
        ...
        self.assertTrue(
            any(
                "ac.ghost" in error and "no source symbol" in error for error in errors
            ),
            errors,
        )
    ...
    def test_stale_epoch_is_rejected(self):
        temporary_directory, root = initialize_coverage_fixture(
            overrides={
                "schemas/agentic-circuit/contracts/acsim.yaml": ACSIM_MANIFEST.replace(
                    '"0.4"', '"0.0"'
                )
            }
        )
    ...
    def test_missing_negative_coverage_is_reported(self):
        temporary_directory, root = initialize_coverage_fixture(
            removals=("tests/mlir/agentic-circuit/ACIR/system-invalid.mlir",)
        )
        self.addCleanup(temporary_directory.cleanup)
        errors = self.check_fixture(root)
        self.assertTrue(
    ...
    def test_missing_positive_coverage_is_reported(self):
        temporary_directory, root = initialize_coverage_fixture(
            removals=("tests/mlir/agentic-circuit/ACSim/model-valid.mlir",)
        )
        self.addCleanup(temporary_directory.cleanup)
        errors = self.check_fixture(root)
        self.assertTrue(
    ...
    def test_substring_coverage_does_not_count(self):
        ...
        temporary_directory, root = initialize_coverage_fixture(
            overrides={
                "tests/mlir/agentic-circuit/ACIR/system-valid.mlir": "ac.systemx @soc {}\n!ac.struct<@s>\n"
            }
        )
        self.addCleanup(temporary_directory.cleanup)
        errors = self.check_fixture(root)
    ...
    def test_missing_registration_table_is_reported(self):
        temporary_directory, root = initialize_coverage_fixture(
            overrides={
                "compiler/acir/lib/Dialect/ACSim/ACSimTypes.cpp": "void initialize() {}\n"
            }
        )
        self.addCleanup(temporary_directory.cleanup)
        errors = self.check_fixture(root)
    ...
    def test_stale_ledger_is_rejected(self):
        temporary_directory, root = initialize_coverage_fixture()
        self.addCleanup(temporary_directory.cleanup)
        ledger = root / "docs/development/acir/verification/ir-coverage.md"
    ...
    def test_missing_ledger_is_reported(self):
        temporary_directory, root = initialize_coverage_fixture()
        self.addCleanup(temporary_directory.cleanup)
        (root / "docs/development/acir/verification/ir-coverage.md").unlink()
        errors = self.check_fixture(root)
        self.assertTrue(
