...
//--- write.mlir
module attributes {ac.model_kind = "queue_graph", ac.queue_graph_domain = "cycle", ac.system = "unsafe_write"} {
  ac.table @entries entry i2 entries 5 init 0 owner "/" stable_id "table/entries"
  %input = ac.source depth 1 latency 1 {ac.name = "input"} : !ac.queue<i3>
...
//--- get.mlir
module attributes {ac.model_kind = "queue_graph", ac.queue_graph_domain = "cycle", ac.system = "unsafe_get"} {
