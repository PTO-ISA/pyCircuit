...
// Each typed case owns its own state, rule and single-writer proof.
// CHECK-COUNT-2: ac.arch_obligation @"single_writer:table/body/state:process:process:state/a:state/b"
// CHECK-COUNT-2: ::process::single_writer:table/body/state:process:process:state/a:state/b
