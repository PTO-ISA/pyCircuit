...
// CANONICAL: module attributes {ac.contract_epoch = "0.5"}
// MISSING: error: expected top-level 'ac.contract_epoch' string attribute equal to "0.5"
// WRONG: error: expected top-level 'ac.contract_epoch' string attribute equal to "0.5"
