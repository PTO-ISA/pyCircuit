...
// RUN: %not %acir_opt %t/parent.mlir 2>&1 | %FileCheck %s --check-prefix=PARENT
...
// PARENT: error: 'ac.memory.request' op memory instance is outside the request scope ancestry
