...
// RUN: %FileCheck %s --check-prefix=MODULE < %t/output/modules/top.ac.mlir

// CHECK: "artifacts":["frozen.ac.mlir","model.acsim.mlir","modules/top.ac.mlir"]
// CHECK: "schema":"agentic-circuit-compile-result"
// CHECK: "stage":"acsim"
// CHECK: "status":"passed"

// MODULE: ac.module_unit = "top"
// MODULE-COUNT-1: ac.module @top
// MODULE-NOT: ac.system @
