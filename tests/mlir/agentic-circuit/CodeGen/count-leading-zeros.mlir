...
module attributes {ac.contract_epoch = "0.5", ac.model_kind = "queue_graph", ac.queue_graph_domain = "cycle", ac.system = "count_leading_zeros"} {
  ac.type_scope @types {
    ac.struct @Item fields [{name = "value", type = i13}, {name = "count", type = i4}]
  ...
  ^transform(%item: !ac.var<!ac.struct<@types::@Item>>):
    ...
    %count = ac.var.count_leading_zeros %value : !ac.var<i13> -> !ac.var<i4>
...
// PYC: pyc.count_leading_zeros {{.*}} : i13 -> i4
