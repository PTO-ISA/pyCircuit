...
builtin.module attributes {ac.contract_epoch = "0.5"} {
  acsim.model @array epoch "0.5" root @Top construction ["Top.counters[0][0]", "Top.counters[0][1]"] destruction ["Top.counters[0][1]", "Top.counters[0][0]"] fingerprints {
