module attributes {pyc.top = @count_leading_zeros_top, pyc.frontend.contract = "pycircuit"} {
  func.func @count_leading_zeros_top(%value: i13) -> i4 attributes {
      arg_names = ["value"],
      result_names = ["count"],
      pyc.value_params = [],
      ...
      pyc.inline = "false",
      pyc.params = "{}",
      pyc.base = "count_leading_zeros_top",
    ...
    %count = pyc.count_leading_zeros %value : i13 -> i4
