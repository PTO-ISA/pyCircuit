# SMT.THR.TID — Thread Identifier

- Source candidate: `DAV-SMT-THR-TID-0001`
...
schema. FlowKey frontend/backend representation, not hardware state
...
- No independent owner; realize within or at the reviewed parent boundary: FlowKey frontend/backend representation, not hardware state
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:5508` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/FRONTEND_CONTEXT_PACKETS.md:58` — Design review disposition: schema; FlowKey frontend/backend representation, not hardware state
- `docs/specification/davincioo/ndf-next/scalar/smt.md:28` — Normative candidate clause (active status).
