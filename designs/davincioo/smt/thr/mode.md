# SMT.THR.MODE — Thread Mode

- Source candidate: `DAV-SMT-THR-MODE-0001`
...
contained. Serialized run-mode field under CTX
...
- No independent owner; realize within or at the reviewed parent boundary: Serialized run-mode field under CTX
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:5422` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/FRONTEND_CONTEXT_PACKETS.md:62` — Design review disposition: contained; Serialized run-mode field under CTX
- `docs/specification/davincioo/ndf-next/scalar/smt.md:48` — Normative candidate clause (active status).
