# SMT.THR.TSB — Thread Status Block

- Source candidate: `DAV-SMT-THR-TSB-0001`
...
contained. Context status fields under CTX
...
- No independent owner; realize within or at the reviewed parent boundary: Context status fields under CTX
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:5594` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/FRONTEND_CONTEXT_PACKETS.md:61` — Design review disposition: contained; Context status fields under CTX
- `docs/specification/davincioo/ndf-next/scalar/smt.md:42` — Normative candidate clause (active status).
