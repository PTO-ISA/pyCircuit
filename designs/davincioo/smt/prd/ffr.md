# SMT.PRD.FFR — First Fault Register

- Source candidate: `DAV-SMT-PRD-FFR-0001`
...
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/smt/prd/ffr.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

deferred. No source-ISA first-fault register imported without PTO authority

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| predicate_event | TBD | predicate event | unresolved |

## Outputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| predicate_result | TBD | predicate result | unresolved |

Payload names in proposed rows are design pseudotypes until fields, widths and nominal identity are frozen. Queue transport is inferred by the compiler, not a requested public Queue wrapper. Clock/reset/time domain are execution context and must not be invented as ordinary payload ports.

## Owned or containing state

- State ownership unresolved: No source-ISA first-fault register imported without PTO authority
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:5022` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/FRONTEND_CONTEXT_PACKETS.md:76` — Design review disposition: deferred; No source-ISA first-fault register imported without PTO authority
