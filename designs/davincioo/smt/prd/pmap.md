# SMT.PRD.PMAP — Predicate Map

- Source candidate: `DAV-SMT-PRD-PMAP-0001`
...
contained. Predicate map/history inside PREG unless later split is approved
...
- No independent owner; realize within or at the reviewed parent boundary: Predicate map/history inside PREG unless later split is approved
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:5096` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/FRONTEND_CONTEXT_PACKETS.md:74` — Design review disposition: contained; Predicate map/history inside PREG unless later split is approved
