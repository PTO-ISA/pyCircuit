# SMT.PRD.MASK — Predicate Mask

- Source candidate: `DAV-SMT-PRD-MASK-0001`
...
schema. Distinct predicate, execution and PE/data-region mask types
...
- No independent owner; realize within or at the reviewed parent boundary: Distinct predicate, execution and PE/data-region mask types
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:5059` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/FRONTEND_CONTEXT_PACKETS.md:75` — Design review disposition: schema; Distinct predicate, execution and PE/data-region mask types
