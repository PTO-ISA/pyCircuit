# SMT.ARB.RR — Round Robin

- Source candidate: `DAV-SMT-ARB-RR-0001`
...
contained. Independent fairness cursor inside each selected arbiter
...
- No independent owner; realize within or at the reviewed parent boundary: Independent fairness cursor inside each selected arbiter
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:4979` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/FRONTEND_CONTEXT_PACKETS.md:67` — Design review disposition: contained; Independent fairness cursor inside each selected arbiter
- `docs/specification/davincioo/ndf-next/scalar/smt.md:81` — Normative candidate clause (active status).
