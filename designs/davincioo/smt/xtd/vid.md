# SMT.XTD.VID — Vector Identifier

- Source candidate: `DAV-SMT-XTD-VID-0001`
...
deferred schema. Vector-thread identity needs a declared architecture/producer model
...
- No independent owner; realize within or at the reviewed parent boundary: Vector-thread identity needs a declared architecture/producer model
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:5748` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/FRONTEND_CONTEXT_PACKETS.md:78` — Design review disposition: deferred schema; Vector-thread identity needs a declared architecture/producer model
