# SMT.XTD.VTB — Vector Thread Buffer

- Source candidate: `DAV-SMT-XTD-VTB-0001`
...
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/smt/xtd/vtb.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

deferred leaf. Extended vector-thread storage not inferred from PE count
...
- State ownership unresolved: Extended vector-thread storage not inferred from PE count
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:5785` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/FRONTEND_CONTEXT_PACKETS.md:79` — Design review disposition: deferred leaf; Extended vector-thread storage not inferred from PE count
