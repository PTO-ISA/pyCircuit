# SMT.RSC.THRSH — Threshold

- Source candidate: `DAV-SMT-RSC-THRSH-0001`
...
contained. Watermark/hysteresis under PART
...
- No independent owner; realize within or at the reviewed parent boundary: Watermark/hysteresis under PART
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:5336` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/FRONTEND_CONTEXT_PACKETS.md:72` — Design review disposition: contained; Watermark/hysteresis under PART
- `docs/specification/davincioo/ndf-next/scalar/smt.md:114` — Normative candidate clause (active status).
