...
- Source candidate: `DAV-SMT-RSC-QUOTA-0001`
...
contained. Per-flow reserved/borrowable quota under PART
...
- No independent owner; realize within or at the reviewed parent boundary: Per-flow reserved/borrowable quota under PART
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:5250` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/FRONTEND_CONTEXT_PACKETS.md:71` — Design review disposition: contained; Per-flow reserved/borrowable quota under PART
- `docs/specification/davincioo/ndf-next/scalar/smt.md:108` — Normative candidate clause (active status).
