# SMT.RSC.SHARE — Sharing

- Source candidate: `DAV-SMT-RSC-SHARE-0001`
...
contained. Resource-class sharing policy under PART

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| resource_event | TBD | resource event | unresolved |

## Outputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| resource_status | TBD | resource status | unresolved |

Payload names in proposed rows are design pseudotypes until fields, widths and nominal identity are frozen. Queue transport is inferred by the compiler, not a requested public Queue wrapper. Clock/reset/time domain are execution context and must not be invented as ordinary payload ports.

## Owned or containing state

- No independent owner; realize within or at the reviewed parent boundary: Resource-class sharing policy under PART
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:5293` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/FRONTEND_CONTEXT_PACKETS.md:70` — Design review disposition: contained; Resource-class sharing policy under PART
- `docs/specification/davincioo/ndf-next/scalar/smt.md:101` — Normative candidate clause (active status).
