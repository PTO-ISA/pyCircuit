...
- Source candidate: `DAV-GPE-GCU-WAKE-0001`
...
Queue output of GGC. Retained wake records under backpressure.
...
- No independent owner; realize within or at the reviewed parent boundary: Retained wake records under backpressure.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:9330` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:183` — Design review disposition: Queue output of GGC; Retained wake records under backpressure.
