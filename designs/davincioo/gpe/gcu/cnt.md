...
- Source candidate: `DAV-GPE-GCU-CNT-0001`
...
field in GGC. Derived count/bitmap, never an independently mutable owner.
...
- No independent owner; realize within or at the reviewed parent boundary: Derived count/bitmap, never an independently mutable owner.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:9176` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:182` — Design review disposition: field in GGC; Derived count/bitmap, never an independently mutable owner.
