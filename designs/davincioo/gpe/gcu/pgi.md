# GPE.GCU.PGI — Previous Group Instruction

- Source candidate: `DAV-GPE-GCU-PGI-0001`
...
classification field. Producer-group role, not an instruction or module.
...
- No independent owner; realize within or at the reviewed parent boundary: Producer-group role, not an instruction or module.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:9293` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:180` — Design review disposition: classification field; Producer-group role, not an instruction or module.
