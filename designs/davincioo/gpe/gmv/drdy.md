# GPE.GMV.DRDY — Data Ready

- Source candidate: `DAV-GPE-GMV-DRDY-0001`
...
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/gpe/gmv/drdy.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

field/event in GBUF. Data-ready is generation-qualified state.

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| group_move_event_in | TBD | group move event in | unresolved |
...
| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| group_move_event_out | TBD | group move event out | unresolved |

Payload names in proposed rows are design pseudotypes until fields, widths and nominal identity are frozen. Queue transport is inferred by the compiler, not a requested public Queue wrapper. Clock/reset/time domain are execution context and must not be invented as ordinary payload ports.

## Owned or containing state

- State ownership unresolved: Data-ready is generation-qualified state.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:9558` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:186` — Design review disposition: field/event in GBUF; Data-ready is generation-qualified state.
