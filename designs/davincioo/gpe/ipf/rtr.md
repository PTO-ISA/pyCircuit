...
- Source candidate: `DAV-GPE-IPF-RTR-0001`
- Hardware hierarchy: **H3**, within H1 `GPE` / H2 `IPF`
- NDF refinement: **L2 microarchitecture**; module-specific L1 behavior links still require review.
- Recommended disposition: **leaf** (proposal, not registry approval)
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/gpe/ipf/rtr.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

leaf. Computes destinations and validates route metadata.
...
- Independent bounded state is expected but its exact schema is not frozen: Computes destinations and validates route metadata.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:9823` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:194` — Design review disposition: leaf; Computes destinations and validates route metadata.
