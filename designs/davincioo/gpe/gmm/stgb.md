# GPE.GMM.STGB — Stage Buffer B

- Source candidate: `DAV-GPE-GMM-STGB-0001`
- Hardware hierarchy: **H3**, within H1 `GPE` / H2 `GMM`
- NDF refinement: **L2 microarchitecture**; module-specific L1 behavior links still require review.
- Recommended disposition: **leaf** (proposal, not registry approval)
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/gpe/gmm/stgb.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

leaf. Owns Shared-B staging and fanout consumption.

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| shared_write_in | CellBeat | shared write in | proposed |
| cube_read_req_in | SharedReadReq[pe] | cube read req in | proposed |
...
| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| cube_read_rsp_out | SharedReadResp[pe] | cube read rsp out | proposed |
...
- SharedB[entries] with GroupKey, Shared TileRef, beats, producer/consumer masks, fault, generation, lease and tombstone
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:9521` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:189` — Design review disposition: leaf; Owns Shared-B staging and fanout consumption.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:513` — Detailed proposed state and Queue contract.
