# GPE.GMM.GMV — Group Matrix Move

- Source candidate: `DAV-GPE-GMM-GMV-0001`
...
mode/adaptor. Group matrix movement is composed from GLD/STGB/IPF.
...
- No independent owner; realize within or at the reviewed parent boundary: Group matrix movement is composed from GLD/STGB/IPF.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:9404` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:192` — Design review disposition: mode/adaptor; Group matrix movement is composed from GLD/STGB/IPF.
