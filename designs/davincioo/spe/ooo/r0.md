# SPE.OOO.R0 — Recovery Stage 0

- Source candidate: `DAV-SPE-OOO-R0-0001`
...
Recovery Stage 0 is a named pipeline phase or contained state, not an independent architectural owner.

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| resolve | TerminalResult | completion/redirect intake | proposed |

## Outputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| retire_window | RetireWindow | registered ROB update | proposed |

Payload names in proposed rows are design pseudotypes until fields, widths and nominal identity are frozen. Queue transport is inferred by the compiler, not a requested public Queue wrapper. Clock/reset/time domain are execution context and must not be invented as ordinary payload ports.

## Owned or containing state

- State is contained in the owning OOO leaf/assembly; do not create a second owner for R0.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: OOO.R0, source srcs/core/spe/ooo/r0.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/ooo.md:183` — Normative NDF owner/refinement clause.
