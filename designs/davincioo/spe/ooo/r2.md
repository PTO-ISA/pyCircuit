# SPE.OOO.R2 — Recovery Stage 2

- Source candidate: `DAV-SPE-OOO-R2-0001`
...
Recovery Stage 2 is a named pipeline phase or contained state, not an independent architectural owner.

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| commit_decision | CommitDecision | selected decision | proposed |
| handoff_req | HandoffReq | durable post-ROB records | proposed |

## Outputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| recovery_cause | RecoveryCause | flush transaction cause | proposed |

Payload names in proposed rows are design pseudotypes until fields, widths and nominal identity are frozen. Queue transport is inferred by the compiler, not a requested public Queue wrapper. Clock/reset/time domain are execution context and must not be invented as ordinary payload ports.

## Owned or containing state

- State is contained in the owning OOO leaf/assembly; do not create a second owner for R2.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: OOO.R2, source srcs/core/spe/ooo/r2.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/ooo.md:197` — Normative NDF owner/refinement clause.
