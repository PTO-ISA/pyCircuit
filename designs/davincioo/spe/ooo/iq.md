# SPE.OOO.IQ — Issue Queue

- Source candidate: `DAV-SPE-OOO-IQ-0001`
...
Issue Queue is a retained catalog/navigation name whose state belongs to an existing owner or assembly.

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| issue_publish | IssueEntry | aggregate issue boundary | proposed |

## Outputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| issued | IssueAttempt | aggregate picker/read-fabric result | proposed |
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: OOO.IQ, source srcs/core/spe/ooo/iq.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/ooo.md:95` — Normative NDF owner/refinement clause.
