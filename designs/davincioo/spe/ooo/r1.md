# SPE.OOO.R1 — Recovery Stage 1

- Source candidate: `DAV-SPE-OOO-R1-0001`
...
Recovery Stage 1 is a named pipeline phase or contained state, not an independent architectural owner.

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| retire_window | RetireWindow | oldest completion snapshot | proposed |

## Outputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| commit_decision | CommitDecision | microcommit/flush decision | proposed |

Payload names in proposed rows are design pseudotypes until fields, widths and nominal identity are frozen. Queue transport is inferred by the compiler, not a requested public Queue wrapper. Clock/reset/time domain are execution context and must not be invented as ordinary payload ports.

## Owned or containing state

- State is contained in the owning OOO leaf/assembly; do not create a second owner for R1.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: OOO.R1, source srcs/core/spe/ooo/r1.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/ooo.md:190` — Normative NDF owner/refinement clause.
