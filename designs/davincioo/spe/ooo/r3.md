# SPE.OOO.R3 — Recovery Stage 3

- Source candidate: `DAV-SPE-OOO-R3-0001`
...
Recovery Stage 3 is a named pipeline phase or contained state, not an independent architectural owner.

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| recovery_request | Recovery | FLS cleanup phase | proposed |

## Outputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| participant_ack | RecoveryAck | owner-side cleanup completion | proposed |

Payload names in proposed rows are design pseudotypes until fields, widths and nominal identity are frozen. Queue transport is inferred by the compiler, not a requested public Queue wrapper. Clock/reset/time domain are execution context and must not be invented as ordinary payload ports.

## Owned or containing state

- State is contained in the owning OOO leaf/assembly; do not create a second owner for R3.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: OOO.R3, source srcs/core/spe/ooo/r3.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/ooo.md:207` — Normative NDF owner/refinement clause.
