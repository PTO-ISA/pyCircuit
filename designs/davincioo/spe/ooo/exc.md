# SPE.OOO.EXC — Exception

- Source candidate: `DAV-SPE-OOO-EXC-0001`
...
Exception is a named pipeline phase or contained state, not an independent architectural owner.

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| fault_update | FaultPublication | ROB-keyed fault sidecar | proposed |
| fault_query | FaultQuery | retirement fault lookup | proposed |

## Outputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| fault_result | FaultRecord | precise fault sidecar | proposed |

Payload names in proposed rows are design pseudotypes until fields, widths and nominal identity are frozen. Queue transport is inferred by the compiler, not a requested public Queue wrapper. Clock/reset/time domain are execution context and must not be invented as ordinary payload ports.

## Owned or containing state

- State is contained in the owning OOO leaf/assembly; do not create a second owner for EXC.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: OOO.EXC, source srcs/core/spe/ooo/exc.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/ooo.md:235` — Normative NDF owner/refinement clause.
