# SPE.IFU.BPFIFO — Branch Prediction FIFO

- Source candidate: `DAV-SPE-IFU-BPFIFO-0001`
...
Branch Prediction FIFO is a named pipeline phase or contained state, not an independent architectural owner.
...
- State is contained in the owning IFU leaf/assembly; do not create a second owner for BPFIFO.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: IFU.BPFIFO, source srcs/core/spe/ifu/bpfifo.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/ifu.md:300` — Normative NDF owner/refinement clause.
