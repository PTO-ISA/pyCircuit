# SPE.IFU.GHR — Global History Register

- Source candidate: `DAV-SPE-IFU-GHR-0001`
...
Global History Register is a named pipeline phase or contained state, not an independent architectural owner.
...
- State is contained in the owning IFU leaf/assembly; do not create a second owner for GHR.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: IFU.GHR, source srcs/core/spe/ifu/ghr.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/ifu.md:124` — Normative NDF owner/refinement clause.
