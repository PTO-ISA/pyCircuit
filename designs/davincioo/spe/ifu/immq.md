# SPE.IFU.IMMQ — Instruction Memory Miss Queue

- Source candidate: `DAV-SPE-IFU-IMMQ-0001`
...
Instruction Memory Miss Queue is a named pipeline phase or contained state, not an independent architectural owner.
...
- State is contained in the owning IFU leaf/assembly; do not create a second owner for IMMQ.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: IFU.IMMQ, source srcs/core/spe/ifu/immq.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/ifu.md:318` — Normative NDF owner/refinement clause.
