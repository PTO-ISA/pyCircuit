# SPE.IFU.BF3 — B-side Stage 3

- Source candidate: `DAV-SPE-IFU-BF3-0001`
- Hardware hierarchy: **H3**, within H1 `SPE` / H2 `IFU`
- NDF refinement: **L2 microarchitecture**; module-specific L1 behavior links still require review.
- Recommended disposition: **leaf** (proposal, not registry approval)
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/spe/ifu/bf3.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

B-side Stage 3 has distinct persistent ownership, arbitration, storage, or transformation responsibility suitable for a pyCircuit design leaf.
...
- Bounded B-side Stage 3 rows/registers with full FlowKey/epoch and slot-generation qualification where reused.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: IFU.BF3, source srcs/core/spe/ifu/bf3.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/ifu.md:174` — Normative NDF owner/refinement clause.
