# SPE.IFU.SC — Statistical Corrector

- Source candidate: `DAV-SPE-IFU-SC-0001`
...
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/spe/ifu/sc.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

Statistical Corrector lacks a closed semantic or physical profile and must remain non-executable until reviewed.
...
- Architecture/profile semantics for IFU.SC are not closed; ports and state remain unresolved.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: IFU.SC, source srcs/core/spe/ifu/sc.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/ifu.md:287` — Normative NDF owner/refinement clause.
