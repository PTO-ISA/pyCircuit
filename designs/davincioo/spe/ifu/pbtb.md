# SPE.IFU.PBTB — Previous Branch Target Buffer

- Source candidate: `DAV-SPE-IFU-PBTB-0001`
...
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/spe/ifu/pbtb.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

Previous Branch Target Buffer lacks a closed semantic or physical profile and must remain non-executable until reviewed.
...
- Architecture/profile semantics for IFU.PBTB are not closed; ports and state remain unresolved.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: IFU.PBTB, source srcs/core/spe/ifu/pbtb.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/ifu.md:255` — Normative NDF owner/refinement clause.
