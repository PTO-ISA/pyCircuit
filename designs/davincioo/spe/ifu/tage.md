# SPE.IFU.TAGE — Tagged Geometric History Length Predictor

- Source candidate: `DAV-SPE-IFU-TAGE-0001`
...
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/spe/ifu/tage.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

Tagged Geometric History Length Predictor lacks a closed semantic or physical profile and must remain non-executable until reviewed.
...
- Architecture/profile semantics for IFU.TAGE are not closed; ports and state remain unresolved.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: IFU.TAGE, source srcs/core/spe/ifu/tage.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/ifu.md:281` — Normative NDF owner/refinement clause.
