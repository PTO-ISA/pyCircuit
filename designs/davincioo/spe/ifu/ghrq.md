# SPE.IFU.GHRQ — Global History Queue

- Source candidate: `DAV-SPE-IFU-GHRQ-0001`
...
Global History Queue is a named pipeline phase or contained state, not an independent architectural owner.
...
- State is contained in the owning IFU leaf/assembly; do not create a second owner for GHRQ.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: IFU.GHRQ, source srcs/core/spe/ifu/ghrq.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/ifu.md:130` — Normative NDF owner/refinement clause.
