# SPE.BCTRL.CBRG — Command IQ to BISQ Bridge

- Source candidate: `DAV-SPE-BCTRL-CBRG-0001`
...
Command IQ to BISQ Bridge is a named pipeline phase or contained state, not an independent architectural owner.

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| cmdp_command | CommandPacket | complete CMDP identity/payload/leases | proposed |

## Outputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| bisq_command | CommandPacket | retained identity-preserving transfer | proposed |

Payload names in proposed rows are design pseudotypes until fields, widths and nominal identity are frozen. Queue transport is inferred by the compiler, not a requested public Queue wrapper. Clock/reset/time domain are execution context and must not be invented as ordinary payload ports.

## Owned or containing state

- State is contained in the owning BCTRL leaf/assembly; do not create a second owner for CBRG.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: BCTRL.CBRG, source srcs/core/spe/bctrl/cbrg.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/bctrl.md:73` — Normative NDF owner/refinement clause.
