# SPE.IEX.P0 — Pick Preselection Stage 0

- Source candidate: `DAV-SPE-IEX-P0-0001`
...
Pick Preselection Stage 0 is a named pipeline phase or contained state, not an independent architectural owner.

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| eligible_set | IssueCandidates | registered candidate reduction input | proposed |

## Outputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| preselected | IssueCandidates | bounded candidate subset | proposed |

Payload names in proposed rows are design pseudotypes until fields, widths and nominal identity are frozen. Queue transport is inferred by the compiler, not a requested public Queue wrapper. Clock/reset/time domain are execution context and must not be invented as ordinary payload ports.

## Owned or containing state

- State is contained in the owning IEX leaf/assembly; do not create a second owner for P0.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: IEX.P0, source srcs/core/spe/iex/p0.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/iex.md:24` — Normative NDF owner/refinement clause.
