# SPE.IEX.E6 — Execute Stage 6

- Source candidate: `DAV-SPE-IEX-E6-0001`
...
Execute Stage 6 is a named pipeline phase or contained state, not an independent architectural owner.

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| load_result | TerminalResult | load result alignment input | proposed |

## Outputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| aged_result | TerminalResult | registered alignment output | proposed |

Payload names in proposed rows are design pseudotypes until fields, widths and nominal identity are frozen. Queue transport is inferred by the compiler, not a requested public Queue wrapper. Clock/reset/time domain are execution context and must not be invented as ordinary payload ports.

## Owned or containing state

- State is contained in the owning IEX leaf/assembly; do not create a second owner for E6.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: IEX.E6, source srcs/core/spe/iex/e6.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/iex.md:86` — Normative NDF owner/refinement clause.
