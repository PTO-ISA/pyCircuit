# SPE.IEX.E1 — Execute Stage 1

- Source candidate: `DAV-SPE-IEX-E1-0001`
...
Execute Stage 1 is a named pipeline phase or contained state, not an independent architectural owner.

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| execute_request | ExecutePacket | accepted function-unit request | proposed |

## Outputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| stage_result | ExecuteStagePacket | registered stage output | proposed |

Payload names in proposed rows are design pseudotypes until fields, widths and nominal identity are frozen. Queue transport is inferred by the compiler, not a requested public Queue wrapper. Clock/reset/time domain are execution context and must not be invented as ordinary payload ports.

## Owned or containing state

- State is contained in the owning IEX leaf/assembly; do not create a second owner for E1.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: IEX.E1, source srcs/core/spe/iex/e1.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/iex.md:54` — Normative NDF owner/refinement clause.
