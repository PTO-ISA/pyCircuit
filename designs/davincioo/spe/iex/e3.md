# SPE.IEX.E3 — Execute Stage 3

- Source candidate: `DAV-SPE-IEX-E3-0001`
...
Execute Stage 3 is a named pipeline phase or contained state, not an independent architectural owner.
...
- State is contained in the owning IEX leaf/assembly; do not create a second owner for E3.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: IEX.E3, source srcs/core/spe/iex/e3.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/iex.md:67` — Normative NDF owner/refinement clause.
