# SPE.IEX.E4 — Execute Stage 4

- Source candidate: `DAV-SPE-IEX-E4-0001`
...
Execute Stage 4 is a named pipeline phase or contained state, not an independent architectural owner.
...
| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| terminal_result | TerminalResult | retained terminal output | proposed |

Payload names in proposed rows are design pseudotypes until fields, widths and nominal identity are frozen. Queue transport is inferred by the compiler, not a requested public Queue wrapper. Clock/reset/time domain are execution context and must not be invented as ordinary payload ports.

## Owned or containing state

- State is contained in the owning IEX leaf/assembly; do not create a second owner for E4.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: IEX.E4, source srcs/core/spe/iex/e4.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/iex.md:73` — Normative NDF owner/refinement clause.
