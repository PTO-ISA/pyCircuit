# SPE.IEX.E2 — Execute Stage 2

- Source candidate: `DAV-SPE-IEX-E2-0001`
...
Execute Stage 2 is a named pipeline phase or contained state, not an independent architectural owner.

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| stage_input | ExecuteStagePacket | previous stage result | proposed |
...
- State is contained in the owning IEX leaf/assembly; do not create a second owner for E2.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:1` — Catalog row: IEX.E2, source srcs/core/spe/iex/e2.py, status planned/deferred.
- `docs/specification/davincioo/ndf-next/scalar/iex.md:61` — Normative NDF owner/refinement clause.
