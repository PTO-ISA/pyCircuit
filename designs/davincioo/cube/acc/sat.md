# CUBE.ACC.SAT — Saturation

- Source candidate: `DAV-CUBE-ACC-SAT-0001`
...
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/cube/acc/sat.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

stage/control in CVT. Applies only where PTO operation requires saturation.
...
- State ownership unresolved: Applies only where PTO operation requires saturation.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7681` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:170` — Design review disposition: stage/control in CVT; Applies only where PTO operation requires saturation.
