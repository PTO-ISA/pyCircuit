# CUBE.ACC.CVT — Conversion

- Source candidate: `DAV-CUBE-ACC-CVT-0001`
- Hardware hierarchy: **H3**, within H1 `CUBE` / H2 `ACC`
- NDF refinement: **L2 microarchitecture**; module-specific L1 behavior links still require review.
- Recommended disposition: **leaf** (proposal, not registry approval)
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/cube/acc/cvt.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

leaf-family stage. Conversion policy derives from PTO numeric control.
...
- Independent bounded state is expected but its exact schema is not frozen: Conversion policy derives from PTO numeric control.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7564` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:168` — Design review disposition: leaf-family stage; Conversion policy derives from PTO numeric control.
