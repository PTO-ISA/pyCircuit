# CUBE.ACC.RND — Rounding

- Source candidate: `DAV-CUBE-ACC-RND-0001`
...
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/cube/acc/rnd.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

stage/control in CVT. Separate only if shared iterative rounding resource is selected.

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| partial_in | MacPartial | partial in | proposed |
...
| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| converted_fragment_out | ConvertedFragment | converted fragment out | proposed |
...
- State ownership unresolved: Separate only if shared iterative rounding resource is selected.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7644` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:169` — Design review disposition: stage/control in CVT; Separate only if shared iterative rounding resource is selected.
