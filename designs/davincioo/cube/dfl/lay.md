...
- Source candidate: `DAV-CUBE-DFL-LAY-0001`
- Hardware hierarchy: **H3**, within H1 `CUBE` / H2 `DFL`
- NDF refinement: **L2 microarchitecture**; module-specific L1 behavior links still require review.
- Recommended disposition: **leaf** (proposal, not registry approval)
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/cube/dfl/lay.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

leaf. Owns physical-to-logical fragment transformation.
...
- Independent bounded state is expected but its exact schema is not frozen: Owns physical-to-logical fragment transformation.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7866` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:161` — Design review disposition: leaf; Owns physical-to-logical fragment transformation.
