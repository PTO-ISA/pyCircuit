# CUBE.DFL.BBUF — B Operand Buffer

- Source candidate: `DAV-CUBE-DFL-BBUF-0001`
...
Array in RDB. B-role ping/pong banks; Shared fanout lifetime is explicit.
...
- No independent owner; realize within or at the reviewed parent boundary: B-role ping/pong banks; Shared fanout lifetime is explicit.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7755` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:158` — Design review disposition: Array in RDB; B-role ping/pong banks; Shared fanout lifetime is explicit.
