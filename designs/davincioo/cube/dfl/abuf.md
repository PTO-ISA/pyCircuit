# CUBE.DFL.ABUF — A Operand Buffer

- Source candidate: `DAV-CUBE-DFL-ABUF-0001`
...
Array in RDB. A-role ping/pong banks; no independent queue owner initially.
...
- No independent owner; realize within or at the reviewed parent boundary: A-role ping/pong banks; no independent queue owner initially.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7718` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:157` — Design review disposition: Array in RDB; A-role ping/pong banks; no independent queue owner initially.
