# CUBE.DFL.XPOS — Cross-positioning

- Source candidate: `DAV-CUBE-DFL-XPOS-0001`
...
mode/network in LAY. Cross-positioning fabric controlled by retained layout plan.
...
- No independent owner; realize within or at the reviewed parent boundary: Cross-positioning fabric controlled by retained layout plan.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7946` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:162` — Design review disposition: mode/network in LAY; Cross-positioning fabric controlled by retained layout plan.
