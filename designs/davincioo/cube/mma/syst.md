# CUBE.MMA.SYST — Systolic Array

- Source candidate: `DAV-CUBE-MMA-SYST-0001`
...
implementation choice in MAC. Systolic organization is not a semantic module by itself.
...
- No independent owner; realize within or at the reviewed parent boundary: Systolic organization is not a semantic module by itself.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:8106` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:166` — Design review disposition: implementation choice in MAC; Systolic organization is not a semantic module by itself.
