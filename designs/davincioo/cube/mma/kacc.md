# CUBE.MMA.KACC — K-dimension Accumulator

- Source candidate: `DAV-CUBE-MMA-KACC-0001`
- Hardware hierarchy: **H3**, within H1 `CUBE` / H2 `MMA`
- NDF refinement: **L2 microarchitecture**; module-specific L1 behavior links still require review.
- Recommended disposition: **leaf** (proposal, not registry approval)
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/cube/mma/kacc.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

leaf. Owns K-step ordering and exactly-once acceptance.
...
- Independent bounded state is expected but its exact schema is not frozen: Owns K-step ordering and exactly-once acceptance.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7983` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:165` — Design review disposition: leaf; Owns K-step ordering and exactly-once acceptance.
