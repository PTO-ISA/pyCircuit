# CUBE.MMA.MAC — Multiply-Accumulate

- Source candidate: `DAV-CUBE-MMA-MAC-0001`
- Hardware hierarchy: **H3**, within H1 `CUBE` / H2 `MMA`
- NDF refinement: **L2 microarchitecture**; module-specific L1 behavior links still require review.
- Recommended disposition: **leaf** (proposal, not registry approval)
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/cube/mma/mac.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

leaf. Owns multiplier/reduction pipeline occupancy.

## Inputs

| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| positioned_a_in | PositionedOperand | positioned a in | proposed |
| positioned_b_in | PositionedOperand | positioned b in | proposed |
...
| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| mac_partial_out | MacPartial | mac partial out | proposed |
...
- MacPipe`[latency][arrays]` with OpKey, K-step, valid masks, dtype/numeric control, fragments, partial sums and exceptions
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:8020` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:164` — Design review disposition: leaf; Owns multiplier/reduction pipeline occupancy.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:365` — Detailed proposed state and Queue contract.
- `docs/specification/davincioo/ndf-next/tile/cube.md:27` — Normative candidate clause (draft status).
