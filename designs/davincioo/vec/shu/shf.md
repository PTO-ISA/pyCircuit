...
- Source candidate: `DAV-VEC-SHU-SHF-0001`
...
alias/mode in PERM. Vocabulary does not justify another module.
...
- No independent owner; realize within or at the reviewed parent boundary: Vocabulary does not justify another module.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7028` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:144` — Design review disposition: alias/mode in PERM; Vocabulary does not justify another module.
