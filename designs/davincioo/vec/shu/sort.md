...
- Source candidate: `DAV-VEC-SHU-SORT-0001`
...
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/vec/shu/sort.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

deferred leaf. Needs PTO operation coverage and comparator-network choice.
...
- State ownership unresolved: Needs PTO operation coverage and comparator-network choice.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7065` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:145` — Design review disposition: deferred leaf; Needs PTO operation coverage and comparator-network choice.
