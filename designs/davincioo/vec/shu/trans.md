# VEC.SHU.TRANS — Transpose

- Source candidate: `DAV-VEC-SHU-TRANS-0001`
...
mode in PERM. Logical transpose; no hidden descriptor flag.
...
- No independent owner; realize within or at the reviewed parent boundary: Logical transpose; no hidden descriptor flag.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7102` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:146` — Design review disposition: mode in PERM; Logical transpose; no hidden descriptor flag.
