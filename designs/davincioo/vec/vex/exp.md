# VEC.VEX.EXP — Expansion

- Source candidate: `DAV-VEC-VEX-EXP-0001`
...
control path in TLOP. PTO expand-family sequencing, not the SFU exponential function.
...
- No independent owner; realize within or at the reviewed parent boundary: PTO expand-family sequencing, not the SFU exponential function.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7410` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:134` — Design review disposition: control path in TLOP; PTO expand-family sequencing, not the SFU exponential function.
