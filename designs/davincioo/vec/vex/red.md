# VEC.VEX.RED — Reduction

- Source candidate: `DAV-VEC-VEX-RED-0001`
- Hardware hierarchy: **H3**, within H1 `VEC` / H2 `VEX`
- NDF refinement: **L2 microarchitecture**; module-specific L1 behavior links still require review.
- Recommended disposition: **leaf** (proposal, not registry approval)
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/vec/vex/red.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

leaf. Owns reduction tree and operation-qualified partials.
...
| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| reduced_result_out | ReducedResult | reduced result out | proposed |
...
- Reduction[depth] with OpKey, dtype, fragment bitmap, ordered partials, exception summary and final-valid
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7447` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:131` — Design review disposition: leaf; Owns reduction tree and operation-qualified partials.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:277` — Detailed proposed state and Queue contract.
