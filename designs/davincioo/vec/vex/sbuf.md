# VEC.VEX.SBUF — Source Buffer

- Source candidate: `DAV-VEC-VEX-SBUF-0001`
- Hardware hierarchy: **H3**, within H1 `VEC` / H2 `VEX`
- NDF refinement: **L2 microarchitecture**; module-specific L1 behavior links still require review.
- Recommended disposition: **leaf** (proposal, not registry approval)
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/vec/vex/sbuf.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

leaf. Owns per-operation source collection table and returned beats.
...
| cell_read_resp_in | CellReadResp | cell read resp in | proposed |
...
| Name | Payload/type | Meaning | Evidence status |
| --- | --- | --- | --- |
| cell_read_req_out | CellReadReq | cell read req out | proposed |
| operand_window_out | OperandWindow | operand window out | proposed |
...
- Entry[depth] with OpKey, TileRefs, received-cell bitmaps/data, predicate/masks, leases and tombstones
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7484` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:128` — Design review disposition: leaf; Owns per-operation source collection table and returned beats.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:210` — Detailed proposed state and Queue contract.
- `docs/specification/davincioo/ndf-next/tile/vec.md:29` — Normative candidate clause (draft status).
