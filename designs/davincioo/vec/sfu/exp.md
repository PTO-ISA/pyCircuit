# VEC.SFU.EXP — Exponential

- Source candidate: `DAV-VEC-SFU-EXP-0001`
- Hardware hierarchy: **H3**, within H1 `VEC` / H2 `SFU`
- NDF refinement: **L2 microarchitecture**; module-specific L1 behavior links still require review.
- Recommended disposition: **leaf** (proposal, not registry approval)
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/vec/sfu/exp.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

leaf-family instance. Selected function pipeline; exact numeric policy is PTO-owned.
...
- Independent bounded state is expected but its exact schema is not frozen: Selected function pipeline; exact numeric policy is PTO-owned.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:6720` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:135` — Design review disposition: leaf-family instance; Selected function pipeline; exact numeric policy is PTO-owned.
- `docs/specification/davincioo/ndf-next/tile/vec.md:37` — Normative candidate clause (draft status).
