# VEC.SFU.RSQRT — Reciprocal Square Root

- Source candidate: `DAV-VEC-SFU-RSQRT-0001`
- Hardware hierarchy: **H3**, within H1 `VEC` / H2 `SFU`
- NDF refinement: **L2 microarchitecture**; module-specific L1 behavior links still require review.
- Recommended disposition: **leaf** (proposal, not registry approval)
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/vec/sfu/rsqrt.py`
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:6837` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:138` — Design review disposition: leaf-family instance; Approximation choice remains unresolved.
