# VEC.TLOP.UROM — Microcode ROM

- Source candidate: `DAV-VEC-TLOP-UROM-0001`
...
Table inside FSM. Control data, not an independently ticking module.
...
- No independent owner; realize within or at the reviewed parent boundary: Control data, not an independently ticking module.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7256` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:149` — Design review disposition: Table inside FSM; Control data, not an independently ticking module.
