...
- Source candidate: `DAV-VEC-TLOP-DEC-0001`
- Hardware hierarchy: **H3**, within H1 `VEC` / H2 `TLOP`
- NDF refinement: **L2 microarchitecture**; module-specific L1 behavior links still require review.
- Recommended disposition: **leaf** (proposal, not registry approval)
- Proposed implementation path, if accepted as an independent leaf: `designs/davincioo/vec/tlop/dec.py`
- Current design-program execution status: **not implemented**. External source evidence is recorded separately.

leaf. Converts legal EngineCommand to a typed internal plan.
...
- Independent bounded state is expected but its exact schema is not frozen: Converts legal EngineCommand to a typed internal plan.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7139` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:147` — Design review disposition: leaf; Converts legal EngineCommand to a typed internal plan.
