# VEC.TLOP.INJ — Injection

- Source candidate: `DAV-VEC-TLOP-INJ-0001`
...
Queue boundary in FSM. Child-uop injection port, not a second sequencer.
...
- No independent owner; realize within or at the reviewed parent boundary: Child-uop injection port, not a second sequencer.
...
- `docs/specification/davincioo/ndf-next/interfaces/pycircuit-module-catalog.json:7219` — Generated catalog identity, hierarchy and planned source path.
- `docs/architecture/core/l3/COMPUTE_GROUP_PACKETS.md:150` — Design review disposition: Queue boundary in FSM; Child-uop injection port, not a second sequencer.
